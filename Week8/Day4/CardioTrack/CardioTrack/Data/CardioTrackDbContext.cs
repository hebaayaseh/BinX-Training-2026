        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            { 
                ...
                entity.HasIndex(p => p.DoctorId)
                      .HasDatabaseName("IX_Patients_DoctorId");
            ...
            modelBuilder.Entity<VitalSignAlert>(entity =>
            {
                ...
                .HasKey(e => e.Id);
                entity.HasIndex(a => new { a.PatientId, a.IsResolved })
                .HasDatabaseName("IX_VitalSignAlerts_PatientId_IsResolved");
            ...
            modelBuilder.Entity<AuditLog>(entity =>
            {
                ...
                entity.HasOne(e => e.PreformedByUser)
