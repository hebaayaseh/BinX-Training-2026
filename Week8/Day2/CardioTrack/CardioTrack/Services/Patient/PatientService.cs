...
namespace CardioTrack.Services.Patient
{
    public class PatientService : IPatient
    {
        ...
        public async Task<PatientViewVitalSignReponseDto> PatientViewVitalSignAsync(int userId)
        {
        ...
        public async Task<ViewMedicalHistoryResponseDto> ViewMedicalHistoryAsync(int userId)
        {
            var user = await dbContext.users
                .FirstOrDefaultAsync(p => p.Id == userId
                                     && p.IsActive
        ...
        public async Task<ViewMedicationResponseDto> ViewMedicationAsync(int userId)
        {
            var user = await dbContext.users
                .FirstOrDefaultAsync(p => p.Id == userId
                                     && p.IsActive
