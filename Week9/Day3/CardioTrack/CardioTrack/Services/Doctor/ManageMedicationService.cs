...
namespace CardioTrack.Services.Doctor
{
    public class ManageMedicationService : IManageMedication
    {
        ...
        public ManageMedicationService(CardioTrackDbContext dbContext,IAuditLog log)
        {
        ...
        public async Task<AddMedicationResponseDto> AddMedicationAsync(int userId, AddMedicationRequestDto request)
        {
            ...
            await log.LogAsync("Add Medication", "Medication", medication.Id, null, medication);
        ...
        public async Task<string> DeactiveMedicationAsync(int userId, DeactiveMedicationRequestDto request)
        {
            ...
            var oldValue = medication;
            medication.IsActive = false;

            await log.LogAsync("Deactive Medication ", "Medication", medication.Id , oldValue , medication);
            await dbContext.SaveChangesAsync();
        ...
        public async Task<string> UpdateMedicationAsync(int userId, UpdateMedicationRequestDto request)
        {
            ...
            await log.LogAsync("Update Medication ", "Medication", medication.Id, oldValue, medication);
            await dbContext.SaveChangesAsync();
